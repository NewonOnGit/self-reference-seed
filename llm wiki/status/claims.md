...
type: other
status: unknown
tags: [ker-im, quantum, topology, gravity, idempotent, tower, verified, other]
links: [uniqueness, uniqueness, hilbert, hilbert, hilbert]
---

# Claim Status

| Claim | Status | Source | Test | Chain |
|-------|--------|--------|------|-------|
| P²=P | COMPUTED | THEORY.md:15 | production.py "P²=P" | — |
| R²=R+I | COMPUTED | THEORY.md:36 | production.py "R²=R+I" | — |
| N²=-I necessary | COMPUTED | paper_v2.md Thm 2.4b | production.py "N transparent" | [uniqueness](../chains/uniqueness.md) |
...
| Axis 2 unattenuated | COMPUTED | THEORY.md:385 | tower.py N transparent | — |
| ν hierarchy ratio | PARTIAL | predictions.md | m₃=40meV ✓, ratio off | — |
| 5-field structure | OPEN | frontier_dispatch.md | — | — |
| Exponent 17 forcing | OPEN | predictions.md | — | — |
